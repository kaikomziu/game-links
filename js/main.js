...
const GAMES = [
  ...
  },
  {
    ...
    title: "TOWER CLASH",
    emoji: "🏰",
    tags: ["対戦", "オンライン", "タワーディフェンス"],
    desc: "防衛側と侵略側に分かれて戦う非対称タワーディフェンス対戦。防衛側は自動で貯まるゴールドでタワー(単体攻撃のアロー塔・範囲攻撃のキャノン塔・敵を遅くするフロスト塔)を通り道のそばに設置して迎撃、設置済みタワーはタップで60%還元売却も可能。侵略側は自動で貯まるマナでユニット(バランス型のグラント・高速のランナー・高耐久高火力のタンク)を送り込み、拠点までたどり着かせる。制限時間(3分)内に拠点HPを0にすれば侵略側の勝利、守り切れば防衛側の勝利。5桁ルームコードでのオンライン対戦(ホストが役割を選ぶと相手は自動でもう一方に)でPCとスマホのクロスプレイに対応、CPU対戦(4段階)も搭載。",
