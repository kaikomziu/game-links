...
const GAMES = [
  {
    ...
    emoji: "⚔️",
    tags: ["その他"],
    desc: "ドット絵のクラシックターン制RPG。コミカルな一人旅の勇者となって、王国からはじまり港町・雪山・砂漠・王都と5つの章を巡りながら魔王討伐を目指す王道ファンタジー。たたかう/とくぎ/どうぐ/にげるのコマンドバトルに属性相性・クリティカル・回避を実装し、ワールドマップは自由に行き来可能でランダムエンカウントが発生する。経験値でのレベルアップ、武器・防具・アクセサリの装備、ショップでの売買、宿屋での回復、モンスター図鑑コンプリートなどのやり込み要素を搭載。各章の中ボスを倒すと道が開けるフラグ制の進行で、クリア後は隠しダンジョンと裏ボスに挑戦できる引き継ぎ周回も可能。セーブは自動でlocalStorageに記録され、力尽きても直前地点からペナルティなしで再開できる。BGM・効果音はWeb Audio APIによる完全内部合成。",
    url: "https://kaikomziu.github.io/hero-quest/"
  },
  {
    id: "compose-deluxe",
    ...
    emoji: "🎼",
    tags: ["ツール"],
    desc: "クリックだけで曲が作れるブラウザ作曲ツール。メロディ/ベース/ドラムのトラックにポチポチ打ち込むステップシーケンサー形式で、BPM・小節数・波形(サイン/トライアングル/矩形/ノコギリ)・音量/ミュート/ソロを調整可能。キーとスケール(メジャー/マイナー)を選ぶとダイアトニックコードが自動表示され、王道進行やカノン進行などの定番コード進行プリセットをワンクリックでトラックに反映できる。音源はWeb Audio APIによる内部合成で外部音声ファイル不使用。作った曲はブラウザに自動保存され、JSONでの書き出し/読み込みにも対応。",
    url: "https://kaikomziu.github.io/compose-deluxe/"
  },
  {
    id: "court-deluxe",
    title: "COURT DELUXE",
    emoji: "⚖️",
    tags: ["ツール"],
    desc: "部屋を作って役職(タグ)を決め、裁判官BOTの進行でリアルタイムに議論できる模擬裁判・会議アプリ。部屋作成者はお題(議題)とパスワードを決め、原告・検察官/被告人/弁護人/証人/傍聴人などの役職と人数を事前に設定できる(独自の役職名も追加可能、不要な役職は0人にしてOK)。参加者は部屋コード+パスワードで入室してニックネームと役職を選び、ホストが開廷すると裁判官BOTが開廷宣言・出席確認・進行説明を行って最初の発言者を指名する。以降は誰でも次の発言者を指名でき、重要な発言には⭐マークを付けられる。議論が出尽くしたら誰でも「まとめを求める」ボタンで裁判官BOTに論点整理を依頼できるが、判決や勝敗は一切出さない設計。複数人でのリアルタイム同時接続に対応。PC/スマホ対応。",
    url: "https://kaikomziu.github.io/court-deluxe/"
  },
  {
    id: "kage-0413",
    title: "KAGE: 04:13",
    emoji: "🕯️",
    tags: ["ホラー・ノベル"],
    desc: "Gemini AI制作。旧市立病院の地下棟を、音を立てずに進む短編ホラー。暗い廊下の奥で起きる異変を調べ、精神を保ちながら朝まで生き残る。Web Audio APIの動的な効果音、CSS 3Dの一人称廊下、人影の演出、精神値による2種類のエンディングを搭載。PCは矢印キー/WASD/Space、スマホは画面上のボタンで操作可能。ヘッドフォン推奨。",
    author: "Gemini AI",
  ...
  },
  {
    ...
    emoji: "🫧",
    tags: ["その他"],
    desc: "無限に潰し続けられるバブルラップ(プチプチ)緩衝材シミュレーター。画面いっぱいに敷き詰められたバブルをタップ、あるいは指でなぞってドラッグすると連続でプチプチ潰せる。潰すたびに合成音源でリアルな「プチッ」という破裂音が鳴り、対応端末では軽い振動も発生。一度潰したバブルは0.7〜2.6秒程度のランダムな時間で自動的にまた膨らむため、シートが尽きることなく本当に無限に潰し続けられる。累計で何回潰したかはブラウザに記録され、閉じてもまた同じ数から続けられる。音はワンタップでミュート可能。ただひたすら無心にプチプチしたい人向けの癒やし系フィジェットトイ。PC/スマホ対応。",
    url: "https://kaikomziu.github.io/puchipuchi-deluxe/"
  },
  {
    id: "game-idea-maker",
    title: "ゲームアイデアメーカー",
    emoji: "🎰",
    tags: ["ツール"],
    desc: "「ジャンル」「舞台」「特殊ルール」の3つをランダムに組み合わせて、ゲームの企画アイデアを一瞬で量産できるジェネレーター。各カテゴリ300種類以上を用意していて、組み合わせ数は約2700万通り。スロット風の演出でガチャを回すようにボタン一つで新しいアイデアが出てきて、気に入らなければ3つのうち1つだけを個別に振り直すことも可能。生成した組み合わせは自動で履歴に残り、気に入ったものはお気に入り登録してあとから見返せる。ゲームジャムのお題出しや企画のアイデア出し、暇つぶしに。PC/スマホ対応。",
    url: "https://kaikomziu.github.io/game-idea-maker/"
  },
  {
    id: "ai-town-deluxe",
    ...
    emoji: "🏘️",
    tags: ["シミュレーション"],
    desc: "8人の住人が暮らす架空の町を上から眺めるだけの放置系シミュレーション。パン屋・花屋・画家・司書・元漁師・小学生・市場の店主・大工という異なる仕事とスケジュール、性格(元気/皮肉屋/のんびり/心配性など)を持った住人たちが、時間経過とともに自宅・職場・公園・カフェ・図書館・広場などをそれぞれの生活リズムで歩き回る。同じ場所に居合わせると天気やその日のイベント、二人の関係性に応じた会話が自動生成され、右側の「町のできごとログ」にリアルタイムで流れていく。住人アイコンをクリックすると現在の様子・心の声・元気/社交/楽しさのステータスが見られる。天気は日替わりで変化し、まれにお祭りなどの特別イベントも発生。時間の流れは一時停止や1x/2x/4x速度に切り替え可能。PC/スマホ対応。",
  ...
  },
  {
    ...
    emoji: "⛰️",
    tags: ["アクション"],
    desc: "Getting Over It風の物理登りゲーム。壺に入ったキャラクターがハンマー1本だけを頼りに、理不尽な地形が続く山をひたすら登る。画面をドラッグ(スマホは指で)してハンマーを振り回し、岩の出っ張りに引っかけたり叩きつけたりして体を持ち上げていく。ハンマーの当たり判定は地形の折れ線に対する物理演算で、油断すると足場を失って下まで滑り落ちることも。序盤の斜面から、オーバーハング、滑りやすい長い坂、狭いチムニーのジグザグ、V字の谷など、テンポよく難所が変化していき、山頂の旗を目指す。進んだ高さは自動でセーブされ、次に開いたときは「つづきから」で再開できる(タイトルで「さいしょから」を選ぶとリセットも可能)。高度に応じて空の色が朝焼けから満点の星空まで変化する。PC/スマホ対応。",
    url: "https://kaikomziu.github.io/hammer-climb-deluxe/"
  },
  {
    id: "inspector-deluxe",
    ...
    emoji: "🔖",
    tags: ["シミュレーション"],
    desc: "架空の「中央書類管理局」の審査官として、次々届く「申請書」と「身分証明書」を見比べ、本日の規則に沿って承認・却下のスタンプを押していくだけの書類審査シミュレーター(クリッカー要素なし)。DAY1は「有効期限切れは却下」だけのシンプルな規則からスタートし、DAY2で氏名の一致確認、DAY3で写真(アイコン)の一致確認、DAY4で日替わりの公式印影との照合、DAY5で番号の書式チェック、DAY6で生年月日から算出した年齢制限と、日を追うごとに確認すべき規則が1つずつ積み重なっていく。前日までの規則はすべて継続して有効なので、後半は複数の規則を同時に頭に入れながら短時間で判断する必要がある。DAY7以降は全規則が出揃った状態のまま制限時間がさらに短縮され、難度が上がり続ける。制限時間内の処理件数と正答率でスコアが決まり、ミスをした際は違反箇所が赤枠で示されるので次に活かせる。ベストスコアと到達DAYはブラウザに自動保存。PC/スマホ対応。",
    url: "https://kaikomziu.github.io/inspector-deluxe/"
  },
  {
    ...
    emoji: "🪐",
    tags: ["ツール"],
    desc: "二重振り子・ニュートンのゆりかご・バネ(単振動)・放物運動・万有引力の軌道・静電気力・摩擦と傾斜・浮力・自由サンドボックスの9つの物理法則で遊べるプレイグラウンド。表示は完全に2Dだが、内部はThree.js+Cannon.jsによる本物の3D物理エンジンで、位置・回転・力の計算はすべて3Dベクトル/クォータニオンで行われている(見た目だけ2Dに固定したオルソグラフィックカメラ)。全モード共通で、物体をドラッグしてつまみ離すと実際にその速度で動き出す。二重振り子は初期角度をわずかにずらした複製を並べてカオス(初期値鋭敏性)を可視化、万有引力モードは衛星をドラッグで放り投げて楕円軌道や落下を試せ、サンドボックスは重力の向き・強さまで自由に変更できる。各モードのパラメータ(重力・バネ定数・摩擦係数・液体密度など)はリアルタイム調整可能、上部の速度スライダーでスローモーション/早送り/一時停止もできる。PC/スマホ対応。",
    url: "https://kaikomziu.github.io/physics-lab-deluxe/"
  },
  {
    id: "dotbattle",
    title: "ドットバトル",
    emoji: "🔴",
    tags: ["対戦"],
    desc: "エサを食べて大きくなり、自分より小さい相手を飲み込んで吸収するagar.io風の多人数対戦ゲーム。個人戦/チーム戦/感染鬼ごっこ/キングオブザヒル/安全地帯が縮むバトルロイヤルの全5モード(管理者が切替可能)。スピードアップ・シールド・マグネット・巨大化・ミステリーのランダムアイテム、障害物・危険地帯・ワープホールのマップギミック、通常の15倍スコアが手に入る激レア「ゴールデンフード」、連続撃破を実況するキルストリーク演出、絵文字タウント、ミニマップ、参加せず観戦できるモードもあり。ゲストでもすぐ遊べ、アカウント登録すれば実績解除状況を次回以降も引き継げる。まだ何か隠された仕掛けもあるらしい。PC(マウス/WASD+スペースキー)・スマホ(ドラッグ+ボタン)対応。",
    url: "https://dotbattle-466g.onrender.com"
  },
  {
    id: "brawl-deluxe",
    title: "BRAWL DELUXE",
    emoji: "⚔️",
    tags: ["対戦"],
    desc: "オリジナルファイター10体で戦う見下ろし型対戦アクション。アサルトライフルのレックス、一撃必殺のノヴァ、壁越し爆弾のボム太、回復サポートのヒール、高HPショットガンのタンカー、俊足ブーメランのウィンド、連射ツインピストルのショウタ、減速アイスのフロスト、毒ダーツのヴェノム、茂み奇襲のゴーストから選択。モードは中央ジェム鉱山を奪い合うジェムグラブ、安全地帯が縮む10人バトルロイヤルのショーダウン、ボールを相手ゴールへ運ぶ3vs3のブロールボールの全3種、マップ全5種。CPUは4段階の強さ、トロフィーを稼ぐと新ファイターが解放される進行要素あり。茂みに隠れて奇襲したり必殺技ゲージを溜めて逆転を狙おう。PCはWASD+マウス照準、スマホはデュアルバーチャルスティックに対応。",
    url: "https://kaikomziu.github.io/brawl-deluxe/"
  },
  {
    id: "smash-deluxe",
    title: "SMASH DELUXE",
    emoji: "🥊",
    tags: ["対戦"],
    desc: "オリジナルファイター8体で殴り合う、スマブラ風の対戦アクションゲーム。剣士のけんご、パワー型のロケッタ、高速忍者のニンジャカゲ、重量級グラップラーのパンダッシュ、ふわふわ浮遊する魔法少女のマホウショウジョ、遠距離ロボのロボQ、最高の飛行復帰を持つトリシャーマン、最重量タンクのヨロイクマの8人から選び、ダメージ%が高いほど吹っ飛びやすくなる本家準拠のノックバック計算・シールド/回避(その場回避・ローリング・エアドッジ)・つかみと投げ・スマッシュ攻撃の溜め・必殺技(ニュートラル/上/下)を実装。ステージは足場が浮かぶノーマルフィールド、流れる雲の上、溶岩が周期的に噴き上がるようがんこうざん、横に壁があり縦の撃墜だけが決着を分けるくうちゅうとりで、広々としたしんりんのほこらの全5種。アイテムはバット・レイガン・ばくだん・ハート・ホシ・ダッシュブーツ・バリアオーブ・とげのわなの全8種。最大4人対戦(キーボード2人+ゲームパッド2人)、CPUは4段階の強さから選択、ストック戦(1〜5)/時間戦(1〜5分)に対応。スマホ・タブレットはバーチャルスティック+ボタンのタッチ操作に対応、5桁のルームコードで1対1のオンライン対戦も可能。",
    url: "https://kaikomziu.github.io/smash-deluxe/"
  },
  {
    id: "metro-tycoon",
    title: "METRO TYCOON",
  ...
  },
  {
    ...
    emoji: "💰",
    tags: ["クリッカー・放置"],
    desc: "中央のコインをクリックしてお金を稼ぐCookie Clicker風クリッカー。全20種の建物(レモネードスタンド〜銀河コングロマリット)で自動収入を増やし、全8種のクリック強化で1クリックの額を上げる。価格は買うたび1.15倍、まとめ買いx1/x10/x100対応、数字はK/M/B/T…表記。コイン下のボタンでオートクリッカーをON/OFFでき、ONの間は1秒あたり5回自動でクリックし続ける(クリック倍率・バフもそのまま反映、離席中も進行)。画面にランダムで出現する金貨をクリックすると『ラッキー(即時ボーナス)』『フィーバー(生産×7)』『連打フィーバー(クリック×777)』『大当たり(全体×2)』が発動。実績は254種(建物・クリック回数・総資産・転生・ゴールドバー・ツリー・金貨・オートクリッカー・Infinity・プレイ時間など)、解除1個につき全生産+1%で無限に伸びる。今回の獲得額が$100万を超えると転生でき、額に応じてゴールドバー🥇を獲得→全19ノードのアップグレードツリー(クリック/自動収入倍率・購入価格減・開始資金・オフライン強化・🥇獲得量・転生スケール・金貨強化・実績ボーナス2倍)で永久強化。ツリーは🥇全額返却で振り直し可。所持金が$1e308(倍精度の上限)に到達すると次の段階「♾INFINITY」が解禁され、突入すると所持金・建物・ツリー・転生回数がリセットされる代わりに♾Infinityを獲得(1個につき永久に全収入+2%)。なまえを設定すると累計獲得額で競う世界ランキング(上位50名+自分の推定順位、♾やゴールドバーも表示)に参加できる。ニュースティッカー・獲得中バフ表示つき。離席中も収入継続、セーブは自動(localStorage)。PC/スマホ対応。",
  ...
  },
  {
    ...
    emoji: "🪙",
    tags: ["RNG・運試し"],
    desc: "左右どちらかを選び続けるだけ。当たり(1/2)を引けば1段前進、はずれた瞬間スタートに逆戻り。13連続的中でたどり着く 1/8192 が目標で、その先の 1/16384・1/32768… にも挑める。派手な効果音・画面演出、確率のはしご表示、統計、各段の到達回数表、実績54種、1/8192達成で解禁されるオートモード、歴代最高連勝を競う世界ランキング。セーブは端末内。PC(←→キー)/スマホ対応。",
  ...
  },
  {
    ...
    emoji: "🧠",
    tags: ["シミュレーション"],
    desc: "謎の「収容体」を職員に管理させ、作業エネルギーを取り出しながら施設を運営するオリジナルの管理シミュレーター。職員を選んで収容体のセルに割り当てると、本能・洞察・愛着・抑圧の4種の作業エネルギーを供給。1日3フェーズ制で、フェーズ終了ごとに作業を解決し、日次決算で4種すべてのノルマ達成を目指す。作業に失敗し続けると封印カウンターが減少し、0になると収容体が「収容違反」を起こして脱走、放置すると待機中の職員を襲撃する。脱走中は職員を割り当てて鎮圧しないと被害が拡大。ノルマ未達成が続くと信頼度が低下し0で運営終了、職員が全滅しても終了。コインで新規職員の雇用や負傷した職員の休養処置が可能。収容体は全15種(ZAYIN〜ALEPH全5等級)、実績41種。セーブはlocalStorage自動保存。PC/スマホ対応。",
    url: "https://kaikomziu.github.io/lobotomy-deluxe/"
  },
  {
    id: "taiko-sim",
    title: "TAIKO SIM",
    emoji: "🥁",
    tags: ["音楽・リズム"],
    desc: "お手持ちの.tja譜面ファイルと音源ファイルを読み込んで遊べる、太鼓の達人風リズムゲームの非公式プレイヤー。ファイル/フォルダ選択やドラッグ&ドロップでtjaと音源(mp3/ogg/wav等)をファイル名から自動マッチングし、難易度(かんたん/ふつう/むずかしい/おに/裏)を選んでプレイ。自作のTJAパーサーがTITLE/BPM/OFFSET/COURSE/LEVEL/BALLOONや音符データ、BPM変化・拍子変化・スクロール速度・ゴーゴータイム・分岐などのコマンドを解釈し、Canvas描画のスクロール譜面として再生。判定(良/可/不可)・コンボ・魂ゲージ・連打/風船/くす玉に対応し、PC(D/F/J/K)・スマホ(画面タップ)両対応。著作権フリーの自作シンセ音源によるお試しサンプル曲も同梱。読み込んだ譜面・音源ファイルは端末内でのみ処理しサーバーに送信しない。自己ベストスコアのみlocalStorageに保存。",
    url: "https://kaikomziu.github.io/taiko-sim/"
  },
  {
    id: "tower-clash",
    title: "TOWER CLASH",
    emoji: "🏰",
    tags: ["対戦"],
    desc: "ガチャで集めたキャラを編成して挑む本格タワーディフェンス。難易度3段階(かんたん/ふつう/むずかしい)×全5ステージで、ウェーブごとに現れる敵を通り道のそばに設置したキャラで迎撃する。戦って貯めたコイン・勝利報酬でガチャ(★1〜★5、全11種)を引いて仲間を収集、重複はランクアップに変換され永続強化。出撃前に最大6体まで編成でき、戦闘中は設置したキャラをその場でレベルアップ(最大Lv3)・売却も可能。連鎖攻撃・継続ダメージ・後退・周囲強化など特殊効果を持つキャラも登場。サブ要素として、防衛側/侵略側に分かれる非対称のオンライン対戦(5桁ルームコードでPC・スマホ間1対1)にも対応し、防衛側は自分が育てた編成キャラをそのまま持ち込める。",
    url: "https://kaikomziu.github.io/tower-clash/"
  },
  {
    id: "ring-jump-deluxe",
    ...
    emoji: "🔴",
    tags: ["アクション"],
    desc: "自分はボール。タップ／クリック／スペースキーで羽ばたいて浮き、放っておくと落ちていく『フラッピーバード』方式で、迫りくる輪(フープ)の穴だけをくぐり抜けるシンプル操作のハイスコア挑戦ゲーム。輪の枠・天井・地面に当たったら即ゲームオーバー。輪のど真ん中を通すと「SWISH」ボーナスで+2点、外周ギリギリを通す通常くぐりは+1点。スコアが伸びるほど流れる速度がアップし、輪の穴も徐々に狭くなっていく。ベストスコアはlocalStorageに保存。PC・スマホ両対応。",
    url: "https://kaikomziu.github.io/ring-jump-deluxe/"
  },
  {
    id: "skill-tree-game",
    ...
    emoji: "🌳",
    tags: ["クリッカー・放置"],
    desc: "折れた「世界樹」の八つの根を辿り、493個のノードを解放して再生させる巨大スキルツリー放置ゲーム。剣術・魔法・商才・錬金術・知識・武具・精神統一・伝説の8系統×60階層に加え、転生5回で解禁される隠し系統「真実の道」も収録。クリックでSPを稼ぎつつ、Cookie Clicker風の施設8種を購入して自動生産を強化、実績と物語を解放しながら頂を目指す。ツリーをリセットして永続倍率を得る転生システム、ノード・施設をまとめ買いできる「買えるだけ買う」、セーブの書き出し/読み込みにも対応。パン・ズームで巨大なツリーを探索できる。",
    url: "https://kaikomziu.github.io/skill-tree-game/"
  },
  {
    id: "right-knock",
    ...
    emoji: "🚪",
    tags: ["ホラー・ノベル"],
    desc: "深夜、扉を叩く音の回数を数えて『誰なのか』を見極める心理ホラー。大家さんから渡されたノートには『家族は2回、宅配便は3回、隣人は1回。それ以外の回数には絶対に応えるな』と書かれている。夜ごとにノックが響き、覗き穴を見る・呼びかける・扉を開ける・無視するの中から選んで切り抜ける全6夜。回数が合っていても油断はできず、家族の顔をした何かが笑っていたり、ノート自体が書き換わっていたりする。死因は6種類、エンディングは生存と真実の2種。実績26種(隠し実績あり)、記録画面、音量/フラッシュ演出軽減/マイクによる静寂検知の設定を搭載。ノックの音・心音・環境音はすべてWebAudioの自作合成で、外部の音源・画像素材は一切使用していない。PC/スマホ対応。",
    url: "https://kaikomziu.github.io/right-knock/"
  },
  {
    id: "kidoku",
    title: "既読、しないで。",
    emoji: "💬",
    tags: ["ホラー・ノベル"],
    desc: "深夜2時57分、知らない相手からメッセージが届くところから始まるチャット形式の心理ホラー。スマホのロック画面からトーク一覧、実際のチャット画面までを模したUIで進行し、『既読、はやいね』『後ろ、見た?』などのメッセージに既読(タップ)や選択肢で応じていく。画面を離れると相手がそれに気づいて指摘してきたり、操作を止めていると『まだそこにいる?』と問いかけてきたりと、プレイヤー自身の行動そのものが演出に反映される。ぼやけた写真の既読演出、着信画面、既読・タブ切り替え・停止を絡めた反応型の恐怖を経て、応答するか電話を切るかで結末が分岐する。音声はすべてWebAudioの自作合成で外部音源は不使用。「正しいノック」とは別系統の新作ホラー。PC/スマホ対応。",
    url: "https://kaikomziu.github.io/kidoku/"
  },
  {
    id: "paradox-loop",
    title: "PARADOX LOOP",
    emoji: "🌀",
    tags: ["パズル"],
    desc: "時間ループの中で『過去の自分』の分身を利用して脱出する因果ループ脱出パズル。制限ティック数以内にゴールできず時間切れになると、その周のプレイヤーの動きが半透明の『分身』として記録され、次のループで同時に再現される。ドアはプレート(誰かが乗っている間だけ開く)かレバー(一度触れるとループを超えて永遠に開いたままになる)に連動しており、1周目でプレートに乗ったまま時間切れにして分身に任せ、2周目は身軽になったプレイヤー自身がドアを通り抜ける、といった『過去の自分と協力するパズル』を解いていく。全6ステージで、単純な移動から始まり、レバーの永続性、複数の分身を同時に運用する多重ループへと段階的に発展。使用したループ回数に応じて星評価(最大3つ)。矢印キー/WASDまたはスマホのD-Padで操作。",
    url: "https://kaikomziu.github.io/paradox-loop/"
  },
  {
    id: "conveni-deluxe",
    ...
    emoji: "🏪",
    tags: ["シミュレーション"],
    desc: "おにぎり1個だけの小さなコンビニから始まる経営シミュレーション。レジに来たお客さんの商品を長押ししてスキャンすると会計完了、離すと進捗が戻ってしまうので最後まで押し続ける必要がある。列に並んだお客さんには忍耐ゲージがあり、待たせすぎると怒って帰ってしまう(評判ダウン)。一定確率でVIP客が来店し、通常より高額な商品を割増価格で購入してくれる。「PC」画面ではパン・飲み物・お弁当・スイーツ・アイス・揚げ物・コーヒー・雑誌・くじ引きまで全10種の商品を仕入れて品揃えを拡大でき、スキャン速度・客の忍耐時間・集客力・販売価格・VIP出現率・VIP単価アップの各種設備投資、レジ増設(最大3台)も可能。バイトを雇えばそのレジは長押し不要で自動スキャン・自動会計してくれるようになり、離席していた時間もバイトが分の売上を計算して迎えてくれる(最大3時間分)。セーブは自動(localStorage)。PC/スマホ対応。",
    url: "https://kaikomziu.github.io/conveni-deluxe/"
  },
  {
    id: "message-deluxe",
    ...
    emoji: "💬",
    tags: ["ツール"],
    desc: "友達コードでつながるシンプルなメッセージアプリ。ゲストとして始めるとその端末のCookieにログイン情報が保存され(削除すると復元不可)、設定画面からユーザー名+パスワードやパスキー(生体認証/Googleパスワードマネージャー)を追加登録すれば別の端末からもログイン可能。自分専用のフレンドコード(例 D5E2-O32P-I90W)を相手に伝えて申請→相手が承認すると1対1のリアルタイムチャットが始まる。テキストに加えて画像(5MBまで)・動画(20MBまで)の送信、既読表示にも対応。表示名はログインIDとは別にいつでも変更できる。",
    url: "https://kaikomziu.github.io/message-deluxe/"
  },
  {
    id: "stack-deluxe",
    title: "STACK DELUXE",
    emoji: "🧱",
    tags: ["アクション"],
    desc: "左右に動くブロックをクリック/タップ/スペースキーで落として積み上げていくタワーゲーム。ぴったり重ねると「PERFECT!」判定になり、ズレて重なるとはみ出た部分が物理的に崩れ落ちて次のブロックが小さくなる。積むごとにブロックの色が虹色にグラデーションしていき、ズレて完全に外れるとタワーが崩れてゲームオーバー。自己ベスト段数はローカルに保存され、高さ・累計ブロック数・パーフェクト回数・連続パーフェクト・プレイ回数・特殊条件など48種の実績を収録。世界共有のオンラインランキングにも自己ベストを送信できる。PC/スマホ対応。",
    url: "https://kaikomziu.github.io/stack-deluxe/"
  },
  {
    ...
    emoji: "💗",
    tags: ["アクション"],
    desc: "Undertale風の弾幕バトルを自作できるブラウザ製エディタ。骨(ボーン)オブジェクトをキャンバス上でドラッグして移動、先端の回転ハンドルをドラッグして回転させると、現在時刻にキーフレームが自動で打たれる仕組みで攻撃パターンを組み立てられる。タイムラインでキーフレームの時刻・座標・回転・拡大率・不透明度を細かく編集でき、プレビュー再生で動きを確認可能。作った攻撃は「プレイ」タブで矢印キー/WASD(スマホは画面下の十字ボタン)で魂を操作し、実際に骨を避けて耐えきれるか遊べる。横なぎ骨・回転する骨・隙間の壁・十字連打・波状の骨の5種のテンプレートを収録し、パターンはブラウザに保存またはJSONファイルとして書き出し/読み込みできる。",
    url: "https://kaikomziu.github.io/undertale-battle-emulator/"
  },
  {
    id: "scratch-deluxe",
    ...
    emoji: "🪙",
    tags: ["RNG・運試し"],
    desc: "1円玉代わりに指やマウスでこするだけのスクラッチくじゲーム。ブロンズ・シルバー・ゴールドの3種類のチケットをコインで購入し、3×3マスの銀色の膜をドラッグして削っていくと下から絵柄が現れる。同じ絵柄が3つ以上そろうとその絵柄に応じたコインを獲得(そろわなければハズレ)。上位のチケットほど購入コストは高いが景品も豪華になり、ゴールドの最高配当は購入額の50倍。1マスずつこするのが面倒なときは「一気に削る」ボタンで即座に全開示も可能。所持コインが尽きても24時間ごとに無料のブロンズチケットを1枚受け取れるので遊び続けられる。購入枚数・最高配当・収支などの統計と直近の当選履歴もブラウザに自動保存。PC/スマホ対応(タッチドラッグでこすれる)。",
    url: "https://kaikomziu.github.io/scratch-deluxe/"
  },
  {
    id: "joo-j",
    ...
    emoji: "📁",
    tags: ["ホラー・ノベル"],
    desc: "SCP風の異常事象アーカイブを誰でも自由に投稿・編集できるWikiサイト。収容番号(JOO-J-001から)は一覧の空き番号を選ぶか自由入力でき、タイトル・オブジェクトクラス(安全/ユークリッド/ケテル/サウマテル/無力化/未分類)・特別収容プロトコル・説明を記入して新規の収容記録を作成できる。作成済みの記録は誰でも閲覧・編集・追記でき、有用/有用でないの評価も可能。管理者はパスワードでログインすると、組織概要・投稿ルール・全ページ上部のお知らせバナーの編集や、記録の削除ができる。全投稿はSupabaseで共有保存され、他の閲覧者にも反映される。",
    url: "https://kaikomziu.github.io/joo-j/"
  },
  {
    ...
    emoji: "🚪",
    tags: ["ホラー・ノベル"],
    desc: "世紀末、正体不明の擬態生物『アリス』が現れ、家を失った人々が扉という扉に押し寄せるようになった夜を描く選択型サバイバルノベル。テレビのニュースで異変を知った後、チャイムが鳴るたびインターホンモニター越しの映像と会話だけを頼りに、扉の向こうにいるのが人間か[CENSORED]かを見極めて開閉を選ぶ。話しかけて言葉や仕草の違和感を探ることもできるが、判断を誤って招き入れてしまうと、その夜は何事もなく過ぎても翌朝には手遅れになっている。家に迎えた人とは夜に言葉を交わして信頼を積み重ねられ、その積み重ねが最終日の分かれ道――BAD END・GOOD END?・TRUE ENDの3つの結末を左右する。全7日のストーリーモード。PC/スマホ対応。",
    url: "https://kaikomziu.github.io/human-or-censored/"
  },
  {
    id: "anohi-no-machi",
    title: "あの日の町",
