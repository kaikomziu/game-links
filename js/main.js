...
const GAMES = [
  ...
  },
  {
    ...
    emoji: "🔢",
    tags: ["対戦", "推理", "オンライン"],
    desc: "4桁・重複なしの秘密の数字をおたがいに当て合う1vs1。各ラウンド同時提出で、予想した4桁が1桁ずつ色で返る（ワードル式）＝緑はその場所で正解、橙は数字はあるが場所ちがい、灰はハズレ。先に4つとも緑にした人の勝ち。CPUフリー戦は よわい/ふつう/つよい/おに の4段階（つよい以上はミニマックス思考）。レート戦は世界中の人とマッチングしてElo変動、相手不在時はレート帯のCPUと対戦。野良戦は未ランクで気軽に1戦。相手が切断したら勝ち確定かCPU戦に切替。世界ランキングあり。PC(数字キー/Enter)・スマホ対応。",
