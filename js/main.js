...
const GAMES = [
  {
    ...
    emoji: "🪙",
    tags: ["RNG", "運試し", "収集"],
    desc: "1/2の運試しをひたすら連続で勝ち抜くだけ。表で1段前進、裏が出た瞬間スタートに逆戻り。13連勝でたどり着く 1/8192 が目標で、その先の 1/16384・1/32768… にも挑める。確率のはしご表示、統計、各段の到達回数表、実績54種、1/8192達成で解禁されるオートモード。セーブは端末内。PC(スペース)/スマホ対応。",
