...
const GAMES = [
  {
    ...
    emoji: "😤",
    tags: ["アクション", "ネタ", "高難度"],
    desc: "飛び乗った瞬間に前へすっ飛んで穴に落ちる——そんな理不尽トラップだらけの意地悪アクション。『しょぼんのアクション』『I Wanna Be The Guy』系オマージュ。偽の床、消える足場、見えないブロック、天井から降ってくる敵、押した方向と逆に進む操作反転ゾーン、触ると全部台無しの偽ゴール旗など、見た目どおりに動かない仕掛けが全4ステージに散りばめられている。落ち着いて、あわてて飛ばず、光るものに釣られなければ必ずクリアできる設計。死亡回数とタイムを記録。← →/A D移動、Space/↑/Zジャンプ(長押しで高い)、Rでステージやり直し。スマホは画面下ボタン。セーブなし・一本勝負。PC/スマホ対応。",
  ...
  },
  {
    ...
    emoji: "🕓",
    tags: ["ホラー", "探索", "ノベル"],
    desc: "失踪した弟の部屋を、一人称で見まわす一晩だけのホラー。矢印キーや画面端で4方向の壁を向き、気になったものをクリックして調べていく。日記4枚、窓の外に立つ人影、まくらの下の家族写真、止まったまま3時44分をさす腕時計、姿見に映る自分でない誰か、押し入れの中の秘密基地——調べて行動するたび部屋の時計が進み、真夜中が近づくほど画面が侵食され心音が近づく。3時44分ちょうど、ドアがノックされたら「開ける／のぞき穴から見る／息をひそめる」の三択。集めた手がかりの数と選択でエンドが3種に分岐。canvas描画、セーブは端末内。テスト用に ?3:40 等で開始時刻指定。PC/スマホ対応。",
