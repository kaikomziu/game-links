...
const GAMES = [
  ...
  },
  {
    ...
    desc: "ガチャで集めたキャラを編成して挑む本格タワーディフェンス。メインの「キャンペーン」モードは難易度3段階(かんたん/ふつう/むずかしい)×全5ステージで、ウェーブごとに現れる敵を通り道のそばに設置したキャラで迎撃する。戦って貯めたコイン・勝利報酬でガチャ(★1〜★5、全11種)を引いて仲間を収集、重複はランクアップに変換され永続強化。出撃前に最大6体まで編成でき、戦闘中は設置したキャラをその場でレベルアップ(最大Lv3)・売却も可能。連鎖攻撃・継続ダメージ・後退・周囲強化など特殊効果を持つキャラも登場。ほかに防衛側/侵略側に分かれる非対称対戦モードもあり、CPU対戦や5桁ルームコードでのPC・スマホ間オンライン対戦(1対1)にも対応。",
