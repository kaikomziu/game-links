...
const GAMES = [
  {
    ...
    emoji: "💰",
    tags: ["クリッカー", "放置", "シンプル"],
    desc: "中央のコインをクリックしてお金を稼ぐ、シンプルなCookie Clicker風クリッカー。稼いだお金で「ビジネス」タブの自動収入(レモネードスタンド $0.1/秒 〜 テック企業 $1.6M/秒まで10種、前の段を買うと次が解禁)や、「クリック強化」タブの1クリック増強アイテム6種を購入していく。価格は買うたびに1.15倍に上昇し、数字はK/M/B/T…表記。今回の獲得額が $100万を超えると転生でき、額に応じてゴールドバー🥇を獲得。所持金・ビジネス・クリック強化はリセットされるが、🥇で全16ノードのアップグレードツリー(クリック倍率・自動収入倍率・購入価格減・開始資金・オフライン強化・🥇獲得量・転生回数スケールの3系統、前提つき)を永久強化できる。ツリーは🥇全額返却で振り直し可。離席中も自動収入が入る。セーブはブラウザ内に自動保存、フッターのリセットで最初から。PC/スマホ対応。",
